...
# Comment out classes below : CourseListView, CourseDetailsView
...
# Coding Pratice: Create a Class-based Course Detail view
#class CourseDetailsView(View):
    # Handles get request
    #def get(self, request, *args, **kwargs):
        #context = {}
        # We get URL parameter pk from keyword agrument list as course_id
        #course_id = kwargs.get('pk')
        #try:
            # <HINT> Get the course object base on course_id
            #course = Course.objects.get(pk=course_id)
            # <HINT> Append the course object to context
            #context['course'] = course
            # <HINT> Use the render method to return a HTTP response with template
